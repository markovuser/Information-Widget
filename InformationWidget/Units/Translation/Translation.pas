  ...
  Try
    ...
    Begin
      ...
      If cm = Form1.Name Then
        continue;
      If cm = Form1.LabelWindowsVersion Then
        continue;
      If cm = Form1.ALabelUserName Then
        continue;
      If cm = Form1.BLabelGetIP Then
        continue;
      If cm = Form1.CLabelCPU Then
        continue;
      If cm = Form1.ELabelBattery Then
        continue;
      If cm = Form1.DLabelRam Then
        continue;
      If cm = Form1.GLabelDate Then
        continue;
      If cm = Form1.HLabelDay Then
        continue;
      If cm = Form1.FLabelDateTime Then
        continue;
